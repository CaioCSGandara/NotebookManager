...
public class ReservaJsonTest {
    ...
    public void listaReservasDeserializationTest() throws Exception {
        ...
        Aluno aluno1 = new Aluno(1, "Julio Correa", "09135616", "jcorrea@puccampinas.edu.br", "(19)90914-3014", Curso.MEDICINA);
        ...
        Aluno aluno2 = new Aluno(2, "Maria Ferreira", "03781923", "maria.ferreira@puccampinas.edu.br", "(19)90814-2314", Curso.TERAPIA_OCUPACIONAL);
        ...
        Aluno aluno3 = new Aluno(3, "Fernando Pontes", "90174823", "fernandohpontes@puccampinas.edu.br", "(19)83914-0945", Curso.BIOMEDICINA);
